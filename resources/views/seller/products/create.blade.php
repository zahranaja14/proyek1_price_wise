                ...
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nama_produk" id="nama_produk" value="{{ old('nama_produk') }}" placeholder="Contoh: Sepatu Sneakers Nike Airmax" required class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 dark:bg-gray-900 dark:border-gray-700 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-gray-800 dark:text-gray-200">
                            @error('nama_produk')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="harga" id="harga" value="{{ old('harga') }}" placeholder="0" min="0" required class="w-full pl-12 pr-4 py-3 rounded-xl bg-gray-50 border border-gray-200 dark:bg-gray-900 dark:border-gray-700 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-gray-800 dark:text-gray-200">
                            </div>
                            @error('harga')
                                <p class="text-sm text-rose-500 mt-2">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" name="stok" id="stok" value="{{ old('stok', 1) }}" placeholder="1" min="0" required class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 dark:bg-gray-900 dark:border-gray-700 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-gray-800 dark:text-gray-200">
                            @error('stok')
                                <p class="text-sm text-rose-500 mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="5" placeholder="Tuliskan kondisi produk, kelengkapan, minus, dll..." required class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 dark:bg-gray-900 dark:border-gray-700 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-gray-800 dark:text-gray-200">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <p class="text-sm text-rose-500 mt-2">{{ $message }}</p>
                            @enderror
                        </div>
